...
describe('lib/optimizely', function() {
  ...
  describe('APIs', function() {
    ...
    describe('#activate', function() {
      ...
      it.only('should call bucketer and dispatchEvent with proper args and return variation key if user is in grouped experiment', function() {
        fakeDecisionResponse = {
          result: '662',
          reasons: [],
        };
        ...
        var eventDispatcherCall = eventDispatcher.dispatchEvent.args[0];
        assert.containSubset(eventDispatcherCall[0], expectedObj);
      });
