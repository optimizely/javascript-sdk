...
describe('lib/optimizely', function() {
  ...
  describe('constructor', function() {
    ...
    describe('constructor', function() {
      it('should log if the client engine passed in is invalid', function() {
        ...
        assert.strictEqual(logMessage, sprintf(INVALID_CLIENT_ENGINE, 'OPTIMIZELY', 'undefined'));
      });
      ...
      it('should log if the defaultDecideOptions passed in are invalid', function() {
        ...
        sinon.assert.called(createdLogger.log);
        var logMessage = buildLogMessageFromArgs(createdLogger.log.args[0]);
        assert.strictEqual(logMessage, sprintf(INVALID_DEFAULT_DECIDE_OPTIONS, 'OPTIMIZELY'));
      });
  ...
  describe('APIs', function() {
    ...
    describe('#activate', function() {
      ...
      it('should return null if experiment is not running', function() {
        ...
        assert.strictEqual(
          logMessage2,
          sprintf(NOT_ACTIVATING_USER, 'OPTIMIZELY', 'testUser', 'testExperimentNotRunning')
        );
      });
      ...
      it('should log an error for invalid experiment key', function() {
        ...
        assert.strictEqual(
          logMessage2,
          sprintf(NOT_ACTIVATING_USER, 'OPTIMIZELY', 'testUser', 'invalidExperimentKey')
        );
      });
      ...
      it('should not activate when optimizely object is not a valid instance', function() {
        ...
        var logMessage = buildLogMessageFromArgs(createdLogger.log.args[0]);
        assert.strictEqual(logMessage, sprintf(INVALID_OBJECT, 'OPTIMIZELY', 'activate'));
  ...
  describe('event batching', function() {
    ...
    // TODO: these tests does not belong here, these belong in EventProcessor tests
