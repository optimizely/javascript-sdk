...
const getMockProjectConfigManager = (opt = {}) => {
  return {
    start: sinon.stub(),
    onRunning: () => opt.onRunning || Promise.resolve(),
    stop: sinon.stub(),
    onTerminated: () => opt.onTerminate || Promise.resolve(),
    getConfig: function() {
      return this.config;
    },
...
describe('lib/optimizely', function() {
  ...
  describe('decide APIs', function() {
    ...
    describe('#createUserContext', function() {
      beforeEach(function() {
        const mockConfigManager = getMockProjectConfigManager();
        const datafile = testData.getTestDecideProjectConfig();
  ...
  describe('audience match types', function() {
    ...
    beforeEach(function() {
      const mockConfigManager = getMockProjectConfigManager();
      const datafile = testData.getTypedAudiencesConfig();
