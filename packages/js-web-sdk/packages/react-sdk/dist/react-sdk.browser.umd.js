(function (global, factory) {
    ...
    (global = global || self, factory(global.optimizelyReactSdk = {}, global.React));
    ...
    */
    ...
    function createDeprecationWarning() {
      ...
      return function (message) {
        warning_1(alreadyWarned, message);
        alreadyWarned = true;
      };
    }
      ...
      var Consumer = function (_React$Component2) {
        ...
        Consumer.prototype.componentDidMount = function componentDidMount() {
          ...
          if (this.broadcast) {
            ...
            warning_1(this.props.quiet, "<Consumer> was rendered outside the context of its <Provider>");
          }
        };
