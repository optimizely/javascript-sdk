...
- Allow using `--isolatedModules` flag in TSConfig file by fixing exports in event processor ([#610](https://github.com/optimizely/javascript-sdk/pull/610))
- Fix strictNullChecks type errors ([#611](https://github.com/optimizely/javascript-sdk/pull/611))
