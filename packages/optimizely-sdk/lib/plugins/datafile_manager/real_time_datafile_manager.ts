...
import { RealtimeDatafileManager } from '@optimizely/js-sdk-datafile-manager';
...
export function createRealtimeDatafileManager(
  sdkKey: string,
  logger: LoggerFacade,
  ...
  return new RealtimeDatafileManager(datafileManagerConfig);
}
