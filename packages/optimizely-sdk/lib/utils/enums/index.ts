...
export const LOG_MESSAGES = {
  ...
  USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED: `%s: Variation %s is mapped to flag %s, rule %s and user %s in the forced decision map.'`,
  USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED: '%s: Variation %s is mapped to flag %s and user %s in the forced decision map.',
  USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED_BUT_INVALID: '%s: Invalid variation %s is mapped to flag %s, rule %s and user %s in the forced decision map.',
  USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED_BUT_INVALID: '%s: Invalid variation %s is mapped to flag %s and user %s in the forced decision map.',
