  ...
  plugins: [
    ...
    commonjs({
      namedExports: {
        ...
        '@optimizely/js-sdk-event-processor': ['LogTierV1EventProcessor', 'LocalStoragePendingEventsDispatcher', 'ReactNativeEventProcessor'],
      },
    }),
  ],
  ...
  output: [
    {
      name: 'optimizelySdk',
      format: 'umd',
      globals: {'@react-native-community/async-storage': 'asyncStorage'},
