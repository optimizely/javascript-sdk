...
console.log('err key ', Object.keys(ERROR_MESSAGES).map((k) => k.length).reduce((a, b) => a + b, 0));
console.log('err val ', Object.values(ERROR_MESSAGES).map((k) => k.length).reduce((a, b) => a + b, 0));
console.log('log key ', Object.keys(LOG_MESSAGES).map((k) => k.length).reduce((a, b) => a + b, 0));
console.log('log val ', Object.values(LOG_MESSAGES).map((k) => k.length).reduce((a, b) => a + b, 0));